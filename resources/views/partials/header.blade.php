<div class="slim-header">
  <div class="container">
    <div class="slim-header-left">
      <h2 class="slim-logo"><a href="{{url('dashboard')}}"><img src="{{asset('assets/img/nbnghgh.png')}}" class="custom-logo" alt="Entertech"></a></h2>
    ...
    <div class="slim-header-right">
      ...
      <div class="dropdown dropdown-c">
        <a href="#" class="logged-user" data-toggle="dropdown">
            @if(Auth::user()->image)
               <img id="header_image" src="{{asset('assets/images/'.Auth::user()->image)}}" alt="">
            @else
             <img src="http://via.placeholder.com/500x500" alt="">
            @endif
          <span id="header_name">{{Auth::user()->name}}</span>
